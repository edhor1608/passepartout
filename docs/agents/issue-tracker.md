...
Keep the Linear project description short: goal, scope, and links to important Documents. Do not use the project description as a replacement for a PRD/RFC/ADR/Research Document.
